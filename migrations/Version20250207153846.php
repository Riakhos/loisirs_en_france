 ...
 */
final class Version20250207153846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD category_id INT DEFAULT NULL, ADD subcategory_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP category_id, DROP subcategory_id');
    }
}
